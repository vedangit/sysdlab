      ...
      <section className="mb-10 border border-zinc-800 bg-[#101010]">
        ...
        <div className="p-6 md:p-8">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-7 text-zinc-400">
            When a system has multiple concrete variants, the factory keeps client code
            independent from constructor details while making extension easier to reason about.
          </p>
